import { Star, Pencil, Trash2, DollarSign, Percent, Tag, Package } from "lucide-react";
...
const EDITABLE_FIELDS: ColumnKey[] = ["price", "stock", "rating", "brand"];
      ...
      <div className="flex flex-col gap-1">
        ...
        <div className="relative flex items-center">
          ...
          <input
            type={type}
            value={val ?? ""}
            className={`w-full rounded-lg border pl-8 pr-2.5 py-1.5 text-sm shadow-sm transition-all duration-200 focus:outline-none focus:ring-2 ${
              err
                ? "border-red-400 focus:border-red-500 focus:ring-red-500/20 dark:border-red-500/50"
                : "border-gray-200 focus:border-blue-500 focus:ring-blue-500/20 dark:border-slate-600 dark:bg-slate-800 dark:text-white"
            }`}
            onChange={(e) => {
      ...
      <div className="relative h-48 w-full overflow-hidden bg-gray-100 dark:bg-slate-700">
        ...
        <div className="absolute left-3 top-3 flex items-center gap-2">
          <button
            ...
            className={`flex h-5 w-5 items-center justify-center rounded-md border-2 backdrop-blur-sm transition-all duration-200 ${
              isSelected
